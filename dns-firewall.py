...
if safedns:
    asndb = pyasn.pyasn('/etc/unbound/ipasn.dat') # IP to ASN list, provided and update once per day in repo
...
# when below "safescore" blocking happens
def check_asn(qname, type, baseip):
    tag = 'DNS-FIREWAL SAFEDNS: '
